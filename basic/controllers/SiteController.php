...
class SiteController extends Controller
{
    ...
    {
        $datos= '<pre>';
        //$cliente= \app\models\Clientes::find()->one();
        $cliente= \app\models\Clientes::find()
          ->where(['cifnif'=>'ID000003'])
          ->one();
        $datos.= print_r( $cliente->toArray(), true);
        ...
        //--*/
        $datos.= '</pre>';
        return $this->renderContent($datos);
