...
<div class="usuarios-form">
    ...
    <?= $form->field($model, 'nombre')->textInput(['maxlength' => true,'hidden'=> true]) ?>
    ...
    <?= $form->field($model, 'avisos_marcar_leidos')->textInput(['value' => 0]) ?>
    <?= $form->field($model, 'avisos_eliminar_borrados')->textInput(['value' => 0]) ?>
